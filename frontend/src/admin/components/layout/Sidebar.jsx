...
export function Sidebar({ currentRoute, onNavigate, isMobileOpen, onCloseMobile }) {
  const navItems = [
    ...
    {
      group: 'DealFlow Platform',
      links: [
        { route: '/app/quotations', label: 'Sales Quotations', icon: ExternalLink, isInternal: true },
        { route: '/app/pipeline', label: 'Deal Pipeline', icon: ExternalLink, isInternal: true },
        { route: '/app/health', label: 'Deal Health Analytics', icon: ExternalLink, isInternal: true },
        { route: '/login', label: 'Switch Persona', icon: ExternalLink, isInternal: true },
        { route: '/', label: 'Showcase Overview', icon: ExternalLink, isInternal: true }
      ]
    }
  ];
